        ...
        <div class="container">
            ...
            <form action="{{url('/savecourse')}}" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-75">
                    <input type="text" name="Course_name" placeholder="Enter Course name" id="name" required>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-75">
                  <input type="text" name="Instructor" placeholder="Enter Instructor name" id="name" required>
                </div>
              </div>
